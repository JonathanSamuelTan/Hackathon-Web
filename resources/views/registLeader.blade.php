...
<body>
    <section id="contact-form">
        <div class="information-group">
            ...
            <form  action="store-leader" method="POST" class="form" onsubmit="return Check()" enctype="multipart/form-data">
                @csrf
                <div class="tab">
                    ...
                    <div class="dua">
                        ...
                        <div class="bagi-dua">
                            ...
                            <input type="text" name="leaderGithub" id="ID-Github" placeholder="cth: https://github.com/JhonDoe" pattern="https:\/\/github\.com\/\w+(?:\/\w+)?" />
                        </div>                        
                    </div>
                    <div class="next">
